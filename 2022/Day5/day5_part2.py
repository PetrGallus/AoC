...
for line in parts[1].split("\n"):
    ...
    #THE ONLY CHANGE FROM PART 1 (all other code is the same, only these 2 lines are different)
    stacks[destination].extend(stacks[source][-n:])     #locate the last crates of stacks and extend it into destination stack
